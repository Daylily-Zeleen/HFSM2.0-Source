...
void HFSMVariableRes::_bind_methods() {
    ClassDB::bind_method(D_METHOD("get_name"), &HFSMVariableRes::get_name);
    ClassDB::bind_method(D_METHOD("set_name", "name"), &HFSMVariableRes::set_name);
...
HFSMVariableRes::HFSMVariableRes() {}

void HFSMVariableRes::set_name(const StringName &name) {
...
StringName HFSMVariableRes::get_name() { return _name; }
...
void HFSMVariableRes::set_default_val(Variant default_val) {
...
Ref<HFSMVariableRes> HFSMVariableRes::create_new(Ref<FsmRes> fsm_res) {
    Ref<HFSMVariableRes> ret;
    ret.instantiate();
    ret->_fsm_res = fsm_res;
    ret->set_name(ret->get_name());
    return ret;
}

void HFSMVariableRes::set_fsm_res(Ref<FsmRes> fsm_res) {
    _fsm_res = fsm_res;
    set_name(_name);
}
