...
#define GDADD_PROPERTY_ORIGIN(m_variant_type, m_property, ...) \
	GDBIND_METHOD(get_##m_property);                           \
	GDBIND_METHOD(set_##m_property, #m_property);              \
	godot::ClassDB::add_property(get_class_static(), PropertyInfo(Variant::m_variant_type, (#m_property), ##__VA_ARGS__), "set_" #m_property, "get_" #m_property)
...
#define GDADD_PROPERTY_BOOL(m_property, ...)      \
	GDBIND_METHOD(is_##m_property);               \
	GDBIND_METHOD(set_##m_property, #m_property); \
	godot::ClassDB::add_property(get_class_static(), PropertyInfo(Variant::BOOL, (#m_property), ##__VA_ARGS__), "set_" #m_property, "is_" #m_property)
