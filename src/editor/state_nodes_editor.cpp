...
namespace Hfsm {
String StateNodesEditor::str_localize(const String &en_key) const {
    return HfsmEditorPlugin::str_localize(en_key);
}
void StateNodesEditor::_bind_methods() {
    ClassDB::bind_method(D_METHOD("__set_current_fsm_res", "current_fsm_res"),
                         &StateNodesEditor::__set_current_fsm_res);
    ClassDB::bind_method(D_METHOD("__set_selected_transition_res_list", "val"),
                         &StateNodesEditor::__set_selected_transition_res_list);
    ClassDB::bind_method(D_METHOD("__set_copied_state_res_list", "val"),
                         &StateNodesEditor::__set_copied_state_res_list);
    ClassDB::bind_method(D_METHOD("__set_copied_transition_list", "val"),
                         &StateNodesEditor::__set_copied_transition_list);
    ClassDB::bind_method(D_METHOD("__set_selected_state_name_list", "val"),
                         &StateNodesEditor::__set_selected_state_name_list);

    ClassDB::bind_method(D_METHOD("__on_current_fsm_res_changed"),
                         &StateNodesEditor::__on_current_fsm_res_changed);
    ClassDB::bind_method(D_METHOD("__on_transition_res_updated"),
                         &StateNodesEditor::__on_transition_res_updated);
    ClassDB::bind_method(D_METHOD("__update_conntion"),
                         &StateNodesEditor::__update_conntion);
    ClassDB::bind_method(D_METHOD("__set_updating", "val"),
                         &StateNodesEditor::__set_updating);
    ClassDB::bind_method(D_METHOD("__select_state_nodes", "val"),
                         &StateNodesEditor::__select_state_nodes);
    ClassDB::bind_method(D_METHOD("___select_mamually", "val"),
                         &StateNodesEditor::___select_mamually);
    ClassDB::bind_method(D_METHOD("__on_popup_menu_id_pressed", "id"),
                         &StateNodesEditor::__on_popup_menu_id_pressed);
    ClassDB::bind_method(D_METHOD("__on_delete_nodes_request", "nodes"),
                         &StateNodesEditor::__on_delete_nodes_request);
    ClassDB::bind_method(D_METHOD("__on_connection_request", "from",
                                  "from_slot", "to", "to_slot"),
                         &StateNodesEditor::__on_connection_request);
    ClassDB::bind_method(D_METHOD("__on_popup_request", "position"),
                         &StateNodesEditor::__on_popup_request);
    ClassDB::bind_method(D_METHOD("__on_node_selected", "node"),
                         &StateNodesEditor::__on_node_selected);
    ClassDB::bind_method(D_METHOD("__on_node_deselected", "node"),
                         &StateNodesEditor::__on_node_deselected);
    ClassDB::bind_method(D_METHOD("__on_create_btn_pressed"),
                         &StateNodesEditor::__on_create_btn_pressed);
    ClassDB::bind_method(D_METHOD("__check_empty_fsm_res_or_not", "val"),
                         &StateNodesEditor::__check_empty_fsm_res_or_not);
    // =======HACK=======
    ClassDB::bind_method(D_METHOD("__on_copy_requested"),
                         &StateNodesEditor::__on_copy_requested);
    ClassDB::bind_method(D_METHOD("__on_paste_requested"),
                         &StateNodesEditor::__on_paste_requested);
    ClassDB::bind_method(D_METHOD("__on_duplicate_requested"),
                         &StateNodesEditor::__on_duplicate_requested);
    ClassDB::bind_method(D_METHOD("__on_edit_fsm_res_requeted"),
                         &StateNodesEditor::__on_edit_fsm_res_requeted);
    // =======HACK=======
}
...
void StateNodesEditor::set_dealing_move_states(bool dealing) {
    dealing_move = dealing;
};

void StateNodesEditor::__set_current_fsm_res(Ref<FsmRes> to_set) {
    if (current_fsm_res.is_valid() &&
        current_fsm_res->is_connected(
            "changed", Callable(this, "__on_current_fsm_res_changed"))) {
        current_fsm_res->disconnect(
            "changed", Callable(this, "__on_current_fsm_res_changed"));
    }
    ...
    if (current_fsm_res.is_valid() &&
        !current_fsm_res->is_connected(
            "changed", Callable(this, "__on_current_fsm_res_changed"))) {
        current_fsm_res->connect(
            "changed", Callable(this, "__on_current_fsm_res_changed"));
    }
}
void StateNodesEditor::__set_selected_state_name_list(
    TypedArray<StringName> to_set) {
    ...
    for (size_t i = 0; i < connection_list.size(); i++) {
        ...
        auto from =
            get_node<StateNode>({conn["from"].operator godot::StringName()});
        auto to =
            get_node<StateNode>({conn["to"].operator godot::StringName()});
        if (from && to) {
            if (selected_state_name_list.has(from->state_res->get_name()) &&
                selected_state_name_list.has(to->state_res->get_name())) {
...
void StateNodesEditor::__set_selected_transition_res_list(
    TypedArray<TransitionRes> to_set) {
    selected_transition_res_list = to_set;
    Ref<TransitionRes> to_inspect = selected_transition_res_list.size() == 1
                                        ? selected_transition_res_list.front()
                                        : nullptr;
    HfsmEditorPlugin::get_singleton()->get_editor_interface()->inspect_object(
        to_inspect.ptr());
    auto conn_list = get_incoming_connections();
    static Ref<TransitionRes> inspecting;
    if (inspecting.is_valid()) {
        inspecting->disconnect("changed",
                               Callable(this, "__on_transition_res_updated"));
        inspecting = Variant(); // 同时只能监视一个 TransitionRes
    }
    if (to_inspect.is_valid()) {
        to_inspect->connect("changed",
                            Callable(this, "__on_transition_res_updated"));
        inspecting = to_inspect;
    }
    queue_redraw();
}
void StateNodesEditor::__set_copied_transition_list(
    TypedArray<TransitionRes> to_set) {
    copied_transition_res_list = to_set;
}
void StateNodesEditor::__set_copied_state_res_list(
    TypedArray<StateRes> to_set) {
    copied_state_res_list = to_set;
}
// ========功能=========
...
void StateNodesEditor::__update_conntion() {
    ...
    for (size_t i = 0; i < conn_list.size(); i++) {
        ...
        auto to =
            get_node<StateNode>({conn["to"].operator godot::StringName()});
        if (!from || !to) {
            disconnect_node(conn["from"], conn["from_port"], conn["to"],
                            conn["to_port"]);
        }
    }
    queue_redraw();
...
void StateNodesEditor::__undo_redo_select_nodes() {
    ...
    undo_redo->add_do_method(this,
                             StringName("__set_selected_transition_res_list"),
                             TypedArray<TransitionRes>());
    undo_redo->add_do_method(this, StringName("__select_state_nodes"),
                             selected_state_name_list);
    undo_redo->add_undo_method(this, StringName("__select_state_nodes"),
                               __bakcup_selected_state_name_list.duplicate());
    undo_redo->add_undo_method(this,
                               StringName("__set_selected_transition_res_list"),
                               selected_transition_res_list.duplicate());
    ...
    for (size_t i = 0; i < conn_list.size(); i++) {
        ...
        if (from && to) {
            ...
            if (__is_judge(pos1, pos2, from_pos, to_pos)) {
                __delete_transition(conn["from"], conn["from_port"], conn["to"],
                                    conn["to_port"]);
            }
        }
    }
...
bool StateNodesEditor::__is_judge(Vector2 apos1, Vector2 apos2, Vector2 bpos1,
                                  Vector2 bpos2) {
    // x 投影重叠
    if ((MAX(apos1.x, apos2.x) >= MIN(bpos1.x, bpos2.x)) &&
        (MIN(apos1.x, apos2.x) <= MAX(bpos1.x, bpos2.x))) {
        // y 投影重叠
        if ((MAX(apos1.y, apos2.y) >= MIN(bpos1.y, bpos2.y)) &&
            (MIN(apos1.y, apos2.y) <= MAX(bpos1.y, bpos2.y))) {
            // A 是否跨过 B
            if ((bpos1 - apos1).cross(apos2 - apos1) *
                    (bpos2 - apos1).cross(apos2 - apos1) <=
                0) {
                // B 是否跨过 A
                if ((apos1 - bpos1).cross(bpos2 - bpos1) *
                        (apos2 - bpos1).cross(bpos2 - bpos1) <=
                    0) {
                    return true;
                }
            }
...
void StateNodesEditor::__delete_transition(const StringName &from,
                                           int32_t from_slot,
                                           const StringName &to,
                                           int32_t to_slot) {
    ...
    if (tr.is_valid()) {
        auto undo_redo =
            HfsmEditorPlugin::create_action("Delete State Transitions");
        undo_redo->add_do_method(this, StringName("disconnect_node"), from,
                                 from_slot, to, to_slot);
        undo_redo->add_do_method(current_fsm_res.ptr(),
                                 StringName("remove_transition_res"), tr);
        undo_redo->add_undo_method(current_fsm_res.ptr(),
                                   StringName("add_transition_res"), tr);
        undo_redo->add_do_method(this, StringName("connect_node"), from,
                                 from_slot, to, to_slot);
        undo_redo->commit_action();
    }
}
TypedArray<TransitionRes>
StateNodesEditor::__try_select_transitions_at_pos(Vector2 pos) {
    ...
    for (size_t i = 0; i < conn_list.size(); i++) {
        ...
        auto verti_ab_extent =
            ab.rotated(Math_PI * 0.5f).normalized() * TRANSITION_SELECT_EXTENT;
...
TypedArray<Vector2>
StateNodesEditor::__get_connection_line_with_zoom(StateNode *from,
                                                  StateNode *to) {
    auto from_pos =
        from->get_connection_output_position(0) + from->get_position();
    auto to_pos = from->get_connection_input_position(0) + to->get_position();
    auto origin_line =
        get_connection_line(from_pos / get_zoom(), to_pos / get_zoom());
    from_pos = origin_line[0] * get_zoom();
    to_pos = origin_line[1] * get_zoom();
    return TypedArray<Vector2>::make(from_pos, to_pos);
}
Ref<TransitionRes> StateNodesEditor::__get_transition_res(StateNode *from,
                                                          StateNode *to) {
    auto tr_list = current_fsm_res->get_transition_res_list();
    for (size_t i = 0; i < tr_list.size(); i++) {
        Ref<TransitionRes> tr = tr_list[i];
        if (tr.is_valid() && tr->get_from_state_res() == from->state_res &&
            tr->get_to_state_res() == to->state_res) {
            return tr;
        }
    }
    return nullptr;
}
bool StateNodesEditor::__is_node_hotzone(Object *in_node, int64_t in_port,
...
void StateNodesEditor::__select_state_nodes(
    ...
    for (size_t i = 0; i < get_child_count(); i++) {
        ...
        if (node) {
            node->set_selected(
                selected_state_name_list.has(node->state_res->get_name()));
        }
    }
}
StateNode *StateNodesEditor::____create_state_node(Ref<StateRes> state_res) {
    return StateNode::create_state_node(state_res);
}
...
// ==================
void StateNodesEditor::__on_current_fsm_res_changed() {
    __check_empty_fsm_res_or_not(current_fsm_res);
}
void StateNodesEditor::__check_empty_fsm_res_or_not(Ref<FsmRes> fsm_res) {
    ...
    if (fsm_res->get_state_res_list().size() <= 0) {
        mask_panel->show();
        not_state_alert->set_text(
            str_localize("The current FSM has not contain a State.\n\n "));
        create_btn->set_text(
            str_localize("Click here to create a Entry State"));
    } else {
        mask_panel->hide();
    }
}
...
void StateNodesEditor::__on_popup_menu_id_pressed(int32_t id) {
    ...
    case ITEM_ADD_STATE: {
        ...
        Ref<StateRes> new_sr;
        new_sr.instantiate();
        new_sr->set_editor_offset(
            (get_local_mouse_position() + get_scroll_ofs()) / get_zoom());
        ...
        undo_redo->add_do_method(this, StringName("___select_mamually"),
                                 TypedArray<StateNode>::make(new_sn));
        undo_redo->add_undo_method(this, StringName("___select_mamually"),
                                   TypedArray<StateNode>());
        undo_redo->add_do_method(current_fsm_res.ptr(),
                                 StringName("add_state_res"), new_sr);
        undo_redo->add_undo_method(current_fsm_res.ptr(),
                                   StringName("remove_state_res"), new_sr);
        undo_redo->commit_action();
        break;
    }
    case ITEM_CUT_STATE: {
        ...
        for (size_t i = 0; i < selected_state_nodes.size(); i++) {
            ...
            undo_redo->add_do_method(current_fsm_res.ptr(),
                                     StringName("remove_state_res"),
                                     node->state_res);
            undo_redo->add_undo_method(current_fsm_res.ptr(),
                                       StringName("add_state_res"),
                                       node->state_res);
        ...
        for (size_t i = 0; i < tr_list.size(); i++) {
            Ref<TransitionRes> tr = tr_list[i];
            auto from_node = Object::cast_to<StateNode>(
                tr->get_from_state_res()->get("state_node"));
            auto to_node = Object::cast_to<StateNode>(
                tr->get_from_state_res()->get("state_node"));
            if (!from_node || !to_node ||
                selected_state_name_list.has(
                    tr->get_from_state_res()->get_name()) ||
                selected_state_name_list.has(
                    tr->get_to_state_res()->get_name())) {
                undo_redo->add_do_method(current_fsm_res.ptr(),
                                         StringName("remove_transition_res"),
                                         tr);
                undo_redo->add_undo_method(current_fsm_res.ptr(),
                                           StringName("add_transition_res"),
                                           tr);
            }
        }
        undo_redo->add_do_method(this,
                                 StringName("__set_copied_transition_list"),
                                 selected_transition_res_list.duplicate());
        undo_redo->add_undo_method(this,
                                   StringName("__set_copied_transition_list"),
                                   copied_transition_res_list);
        undo_redo->add_undo_method(this, StringName("___select_mamually"),
                                   selected_state_nodes);
        undo_redo->add_do_method(this,
                                 StringName("__set_copied_state_res_list"),
                                 to_copied_state_res);
        undo_redo->add_undo_method(this,
                                   StringName("__set_copied_state_res_list"),
                                   copied_state_res_list);
        undo_redo->commit_action();
    } break;
    case ITEM_COPY_STATES: {
        ...
        TypedArray<StateNode> selected_state_node_list =
            get_selected_state_nodes();
        for (size_t i = 0; i < selected_state_node_list.size(); i++) {
            to_copied_state_res_list.push_back(
                selected_state_node_list[i].get("state_res"));
        }
    ...
    case ITEM_PASTE_STATES: {
        ...
        for (size_t i = 0; i < copied_transition_res_list.size(); i++) {
            ...
            if (copied_state_res_list.has(tr->get_from_state_res()) &&
                copied_state_res_list.has(tr->get_to_state_res())) {
                ...
                StringName from =
                    ctr->get_from_state_res()->get("state_node").get("name");
                StringName to =
                    ctr->get_to_state_res()->get("state_node").get("name");
                undo_redo->add_do_method(current_fsm_res.ptr(),
                                         StringName("add_transition_res"), ctr);
                undo_redo->add_do_method(this, StringName("connect_node"), from,
                                         0, to, 0);
                undo_redo->add_undo_method(this, StringName("disconnect_node"),
                                           from, 0, to, 0);
                undo_redo->add_undo_method(current_fsm_res.ptr(),
                                           StringName("remove_transition_res"),
                                           ctr);
    ...
    case ITEM_DUPLICATE_STATES: {
        ...
        for (size_t i = 0; i < selected_state_res_list.size(); i++) {
            ...
            undo_redo->add_undo_method(this, StringName("remove_child"), csn);
            undo_redo->add_do_method(current_fsm_res.ptr(),
                                     StringName("add_state_res"), csr);
            undo_redo->add_undo_method(this, StringName("remove_state_res"),
                                       csr);
        }
        // 拷贝相关转换
        ...
        if (selected_state_res_list.size() > 0) {
            ...
            for (size_t i = 0; i < selected_state_nodes.size(); i++) {
                ...
                if (selected_state_res_list.has(tr->get_from_state_res()) ||
                    selected_state_res_list.has(tr->get_to_state_res())) {
                    StringName from =
                        tr->get_from_state_res()->get("state_node").get("name");
                    StringName to =
                        tr->get_to_state_res()->get("state_node").get("name");
                    undo_redo->add_do_method(
                        this, StringName("disconnect_node"), from, 0, to, 0);
                    undo_redo->add_do_method(
                        current_fsm_res.ptr(),
                        StringName("remove_transition_res"), tr);
                    undo_redo->add_undo_method(current_fsm_res.ptr(),
                                               StringName("add_transition_res"),
                                               tr);
                    undo_redo->add_undo_method(this, StringName("connect_node"),
                                               from, 0, to, 0);
                }
            }
            undo_redo->add_undo_method(this, StringName("___select_mamually"),
            ...
            for (size_t i = 0; i < selected_transition_res_list.size(); i++) {
                ...
                StringName to =
                    tr->get_to_state_res()->get("state_node").get("name");
                undo_redo->add_do_method(this, StringName("disconnect_node"),
                                         from, 0, to, 0);
                undo_redo->add_do_method(current_fsm_res.ptr(),
                                         StringName("remove_transition_res"),
                                         tr);
    ...
    case ITEM_CONVERT_TO_FSM: {
        auto selected_state_res_list = ___get_selected_state_res_list();
        if (!__hovered_state_node ||
            !selected_state_res_list.has(__hovered_state_node->state_res))
            return;
        auto undo_redo = HfsmEditorPlugin::create_action("Convert To Sub-FSM");
        // 复制状态资源
        Ref<StateRes> duplicated_state_res =
            __hovered_state_node->state_res->duplicate(true);
        // 新的子状态机
        Ref<FsmRes> new_fsm_res;
        new_fsm_res.instantiate();
        new_fsm_res->set_nested_state_res(duplicated_state_res);
        // 复制的状态节点
        auto duplicated_state_node =
            ____create_state_node(duplicated_state_res);
        //
        ...
        for (size_t i = 0; i < current_tr_list.size(); i++) {
            ...
            if (tr->get_from_state_res() == __hovered_state_node->state_res &&
                !selected_state_res_list.has(tr->get_to_state_res())) {
                undo_redo->add_do_method(this, StringName("disconnect_node"),
                                         from, 0, to, 0);
                undo_redo->add_do_property(tr.ptr(), "from_state_res",
                                           duplicated_state_res);
                undo_redo->add_do_method(this, StringName("call_deferred"),
                                         StringName("connect_node"),
                                         duplicated_state_node_name, 0, to, 0);
                ...
                undo_redo->add_do_property(tr.ptr(), "from_state_res",
                                           hovered_state_res);
                undo_redo->add_do_method(this, StringName("call_deferred"),
                                         StringName("connect_node"), from, 0,
                                         to, 0);
            } else if (tr->get_to_state_res() ==
                           __hovered_state_node->state_res &&
                       !selected_state_res_list.has(tr->get_from_state_res())) {
                undo_redo->add_do_method(this, StringName("disconnect_node"),
                                         from, 0, to, 0);
                undo_redo->add_do_property(tr.ptr(), StringName("to_state_res"),
                                           duplicated_state_res);
                undo_redo->add_do_method(this, StringName("call_deferred"),
                                         StringName("connect_node"), from, 0,
                                         duplicated_state_node_name, 0);

                undo_redo->add_do_method(this, StringName("disconnect_node"),
                                         from, 0, duplicated_state_node_name,
                                         0);
                undo_redo->add_do_property(tr.ptr(), "to_state_res",
                                           hovered_state_res);
                undo_redo->add_do_method(this, StringName("call_deferred"),
                                         StringName("connect_node"), from, 0,
                                         to, 0);
            } else if ((selected_state_res_list.has(tr->get_from_state_res()) &&
                        !selected_state_res_list.has(tr->get_to_state_res())) ||
                       (selected_state_res_list.has(tr->get_to_state_res()) &&
                        !selected_state_res_list.has(
                            tr->get_from_state_res()))) {
                ...
                undo_redo->add_undo_method(current_fsm_res.ptr(),
                                           StringName("add_transition_res"),
                                           tr);
                undo_redo->add_undo_method(this, StringName("call_deferred"),
                                           StringName("connect_node"), from, 0,
                                           to, 0);
            } else if (selected_state_res_list.has(tr->get_from_state_res()) &&
                       selected_state_res_list.has(tr->get_to_state_res())) {
                ...
                undo_redo->add_do_method(current_fsm_res.ptr(),
                                         StringName("remove_transition_res"),
                                         tr);
                undo_redo->add_do_method(new_fsm_res.ptr(),
                                         StringName("add_transition_res"), tr);

                undo_redo->add_undo_method(
                    new_fsm_res.ptr(), StringName("remove_transition_res"), tr);
                undo_redo->add_undo_method(current_fsm_res.ptr(),
                                           StringName("add_transition_res"),
                                           tr);
                undo_redo->add_undo_method(this, StringName("call_deferred"),
        ...
        undo_redo->add_undo_method(this, StringName("remove_child"),
                                   duplicated_state_node);
        undo_redo->add_undo_method(current_fsm_res.ptr(),
                                   StringName("remove_state_res"),
                                   duplicated_state_res);
        undo_redo->add_undo_property(duplicated_state_res.ptr(), "fsm_res",
                                     nullptr);
        undo_redo->add_undo_property(duplicated_state_res.ptr(), "nested",
                                     false);
        undo_redo->add_undo_property(hovered_state_res.ptr(), "type",
                                     hovered_state_res->get_type());
        undo_redo->add_undo_property(hovered_state_res.ptr(), "state_script",
                                     hovered_state_res->get_state_script());
        // 移动选中节点所处的状态机
        auto selected_state_nodes = get_selected_state_nodes();
        for (size_t i = 0; i < selected_state_nodes.size(); i++) {
            auto sn = Object::cast_to<StateNode>(selected_state_nodes[i]);
            undo_redo->add_do_method(this, "remove_child", sn);
            undo_redo->add_do_method(current_fsm_res.ptr(), "remove_state_res",
                                     sn->state_res);
            undo_redo->add_do_method(new_fsm_res.ptr(), "add_state_res",
                                     sn->state_res);

            undo_redo->add_undo_method(new_fsm_res.ptr(), "remove_state_res",
                                       sn->state_res);
            undo_redo->add_undo_method(current_fsm_res.ptr(), "add_state_res",
                                       sn->state_res);
            undo_redo->add_undo_method(this, "add_child", sn);
            undo_redo->add_undo_reference(sn);
        }
        //
        undo_redo->add_do_property(hovered_state_res.ptr(), "state_script",
                                   nullptr);
        undo_redo->add_do_property(hovered_state_res.ptr(), "type",
                                   State::STATE_TYPE_ENTRY);
        undo_redo->add_do_property(duplicated_state_res.ptr(), "nested", true);
        undo_redo->add_do_property(duplicated_state_res.ptr(), "fsm_res",
                                   new_fsm_res);
        undo_redo->add_do_method(current_fsm_res.ptr(), "add_state_res",
                                 duplicated_state_res);
        undo_redo->add_do_method(this, "add_child", duplicated_state_node);
        undo_redo->add_do_reference(duplicated_state_node);

        undo_redo->add_do_method(
            this, "___select_mamually",
            TypedArray<StateNode>::make(duplicated_state_node));
        undo_redo->add_undo_method(this, "___select_mamually",
                                   selected_state_nodes);
...
void StateNodesEditor::__on_delete_nodes_request(Array nodes) {
    __on_popup_menu_id_pressed(ITEM_DELETE);
}
void StateNodesEditor::__on_connection_request(const StringName &from,
                                               int from_slot,
                                               const StringName &to,
                                               int to_slot) {
    auto from_node = Object::cast_to<StateNode>(find_child(from, false, false));
    ...
    undo_redo->add_do_method(this, "connect_node", from, from_slot, to,
                             to_slot);
    undo_redo->add_undo_method(this, "disconnect_node", from, from_slot, to,
                               to_slot);
    undo_redo->add_do_method(current_fsm_res.ptr(),
                             StringName("add_transition_res"), new_tr);
    undo_redo->add_undo_method(current_fsm_res.ptr(),
                               StringName("remove_transition_res"), new_tr);

    auto new_transiion_res_list = TypedArray<TransitionRes>::make(new_tr);
    undo_redo->add_do_method(this, "__set_selected_state_name_list",
                             TypedArray<StringName>());
    undo_redo->add_undo_method(this, "__set_selected_state_name_list",
                               selected_state_name_list);
    undo_redo->add_do_method(this, "call_deferred",
                             "__set_selected_transition_res_list",
                             new_transiion_res_list);
    undo_redo->add_undo_method(this, "call_deferred",
                               "__set_selected_transition_res_list",
                               selected_transition_res_list);
...
void StateNodesEditor::__on_popup_request(Vector2 position) {
    ...
    menu->add_item(str_localize("Copy States"), ITEM_COPY_STATES,
                   Key(KEYCODE_COPY_STATES));
    menu->add_item(str_localize("Paste States"), ITEM_PASTE_STATES,
                   Key(KEYCODE_PASTE_STATES));
    menu->add_item(str_localize("Duplicate States"), ITEM_DUPLICATE_STATES,
                   Key(KEYCODE_DUPLICATE_STATES));
    menu->add_item(str_localize("Delete"), ITEM_DELETE,
                   Key(KEYCODE_DELETE_STATES));
    menu->add_separator();
    ...
    if (__hovered_state_node &&
        get_selected_state_nodes().has(__hovered_state_node))
        return;
...
void StateNodesEditor::__on_create_btn_pressed() {
    ...
    undo_redo->add_do_method(this, "___select_mamually",
                             TypedArray<StateNode>::make(new_sn));
    undo_redo->add_undo_method(this, "___select_mamually",
                               TypedArray<StateNode>());
    undo_redo->add_do_method(current_fsm_res.ptr(), "add_state_res", new_sr);
    undo_redo->add_undo_method(current_fsm_res.ptr(), "remove_state_res",
                               new_sr);
...
StateNodesEditor::StateNodesEditor() {}

StateNodesEditor *
StateNodesEditor::create_state_nodes_edit(HBoxContainer *path_btn_container) {
    auto r = memnew(StateNodesEditor);
    r->path_button_container = path_btn_container;
    r->font = HfsmEditorPlugin::get_singleton()
    ...
    // 结构
    {
        ...
        r->not_state_alert->set_horizontal_alignment(
    ...
    // 信号
    {
        r->menu->connect("id_pressed",
                         Callable(r, "__on_popup_menu_id_pressed"));
        r->create_btn->connect("pressed",
                               Callable(r, "__on_create_btn_pressed"));
        r->connect("delete_nodes_request",
                   Callable(r, "__on_delete_nodes_request"));
        // ======== HACK =========
        r->connect("copy_nodes_request", Callable(r, "__on_copy_requested"));
        r->connect("paste_nodes_request", Callable(r, "__on_paste_requested"));
        r->connect("duplicate_nodes_request",
                   Callable(r, "__on_duplicate_requested"));
        // ======== HACK =========
        ...
        r->connect("connection_request",
                   Callable(r, "__on_connection_request"));
    ...
    r->activity_color = HfsmEditorPlugin::get_singleton()
                            ->get_editor_interface()
                            ->get_base_control()
                            ->get_theme_color("activity", "GraphEdit");
    return r;
}
...
void StateNodesEditor::edit_fsm_res(Ref<FsmRes> fsm_res) {
    ...
    for (size_t i = 0; i < conn_list.size(); i++) {
        Dictionary conn = conn_list[i];
        undo_redo->add_do_method(this, "disconnect_node", conn["from"],
                                 conn["from_port"], conn["to"],
                                 conn["to_port"]);
        undo_redo->add_undo_method(this, "call_deferred", "connect_node",
                                   conn["from"], conn["from_port"], conn["to"],
                                   conn["to_port"]);
    }
    ...
    //  路径按钮处理
    //  清除路径列表
    for (size_t i = 0; i < path_button_container->get_child_count(true); i++) {
        if (auto btn = Object::cast_to<Button>(get_child(i, true))) {
            undo_redo->add_do_method(path_button_container, "remove_child",
                                     btn);
    ...
    if (fsm_res.is_valid()) {
        ...
        while (nsr.is_valid()) {
            ...
            btn->connect("pressed",
                         Callable(this, "__on_edit_fsm_res_requeted"));
            // 暂时不能使用 Callable::bind()
            // btn->connect("pressed",
            //              Callable(this, "edit_fsm_res").bind(to_fsm_res));
            path_btn_list.push_back(btn);

            to_fsm_res = HfsmEditorPlugin::get_singleton()
                             ->get_hfsm_editor()
                             ->get_nested_fsm_res(nsr);
        ...
        while (!path_btn_list.is_empty()) {
            ...
            undo_redo->add_undo_method(path_button_container, "remove_child",
                                       end);
            undo_redo->add_do_reference(end);
        }
        // 没有状态
        undo_redo->add_do_method(this, "__check_empty_fsm_res_or_not", fsm_res);
        undo_redo->add_undo_method(this, "__check_empty_fsm_res_or_not",
                                   current_fsm_res);
        // 新建并添加节点
        ...
        for (size_t i = 0; i < state_res_list.size(); i++) {
            ...
            undo_redo->add_undo_method(sr.ptr(), "set", "state_node",
                                       old_state_node);
        ...
        for (size_t i = 0; i < transition_res_list.size(); i++) {
            ...
            StringName to =
                tr->get_to_state_res()->get("state_node").get("name");
            undo_redo->add_do_method(this, "call_deferred", "connect_node",
                                     from, 0, to, 0);
...
void StateNodesEditor::_process(real_t delta) {
    ...
    if (!Input::get_singleton()->is_mouse_button_pressed(MOUSE_BUTTON_LEFT)) {
        if (selected_state_name_list.size() !=
            __bakcup_selected_state_name_list.size()) {
    ...
    if (mouse_btn_event) {
        ...
        if (mouse_btn_event->get_button_index() == MOUSE_BUTTON_MIDDLE) {
            if (mouse_btn_event->is_pressed()) {
                ...
                to_disconnect = false;
                __try_disconnect(mouse_btn_event->get_position(),
                                 _disconnect_line[0]);
        ...
        if (mouse_btn_event->get_button_index() == MOUSE_BUTTON_LEFT) {
            if (mouse_btn_event->is_double_click()) {
                if (mouse_btn_event->is_alt_pressed())
                    return;
                // 双击选择转换
                auto selected_tr_list = __try_select_transitions_at_pos(
                    mouse_btn_event->get_position());
                // undoredo
                auto deal_selected_transition = [this,
                                                 selected_tr_list]() -> void {
                    auto undo_redo = HfsmEditorPlugin::create_action(
                        "Select State Transitions");
                    undo_redo->add_do_method(
                        this, StringName("__set_selected_state_name_list"),
                        TypedArray<StringName>());
                    undo_redo->add_do_method(
                        this, StringName("__set_selected_transition_res_list"),
                        selected_tr_list);
                    undo_redo->add_undo_method(
                        this, StringName("__set_selected_transition_res_list"),
                        selected_transition_res_list);
                ...
                if (!mouse_btn_event->is_pressed()) {
                    if (selected_transition_res_list.size() > 0 ||
                        selected_state_name_list.size() > 0) {
                        auto selected_tr_list = __try_select_transitions_at_pos(
                            mouse_btn_event->get_position());
                        if (selected_tr_list.size() == 0 &&
                            !___get_top_state_node_which_hovered()) {
                            auto undo_redo =
                                HfsmEditorPlugin::create_action("Deselect");
                            undo_redo->add_do_method(
                                this,
                                StringName(
                                    "__set_selected_transition_res_list"),
                            ...
                            undo_redo->add_do_method(
                                this,
                                StringName("__set_selected_state_name_list"),
                                TypedArray<StringName>());
                            undo_redo->add_undo_method(
                                this,
                                StringName(
...
bool StateNodesEditor::_is_in_input_hotzone(Object *in_node, int64_t in_port,
                                            const Vector2 &mouse_position) {
    return __is_node_hotzone(in_node, in_port, mouse_position);
}
bool StateNodesEditor::_is_in_output_hotzone(Object *in_node, int64_t in_port,
                                             const Vector2 &mouse_position) {
    return __is_node_hotzone(in_node, in_port, mouse_position);
}
PackedVector2Array
StateNodesEditor::_get_connection_line(const Vector2 &from,
    ...
    for (size_t i = 0; i < get_child_count(); i++) {
        ...
        if (!node)
            continue;
        auto from_slot_pos = node->get_connection_output_position(0) +
                             node->get_position_offset() * get_zoom();
        auto to_slot_pos = node->get_connection_input_position(0) +
                           node->get_position_offset() * get_zoom();
        ...
        if (!from_node) {
            if (from_slot_pos.is_equal_approx(from)) {
                ...
                from_slot_pos = node->get_connection_output_position(0) +
                                node->get_position();
                from_slot_pos /= get_zoom();
                if (from_slot_pos.is_equal_approx(from)) {
                    from_node = node;
        ...
        if (node != from_node && !to_node) {
            if (to_slot_pos.is_equal_approx(to)) {
                ...
                to_slot_pos = node->get_connection_input_position(0) +
                              node->get_position();
                to_slot_pos /= get_zoom();
                if (to_slot_pos.is_equal_approx(to)) {
                    to_node = node;
    ...
    if (from_node) {
        ret[0] =
            from + (Vector2(-1, 0) * from_node->get_size().x * 0.5f +
                    Vector2(0, -1).rotated(angle) * CONN_POS_OFFSET * 0.5f);
    } else {
        ret[0] = from;
    }
    if (to_node) {
        ret[1] = to + (Vector2(1, 0) * to_node->get_size().x * 0.5f +
                       Vector2(0, -1).rotated(angle) * CONN_POS_OFFSET * 0.5f);
    } else {
        ret[1] = to;
    }
...
void StateNodesEditor::_draw() {
    ...
    for (size_t i = 0; i < conn_list.size(); i++) {
        ...
        auto triangle_color =
            UtilityFunctions::lerp(from->OUT_COLOR, from->IN_COLOR, 0.5f);
        triangle_color = UtilityFunctions::lerp(
            triangle_color, activity_color, selected ? activity_amount : 0.0f);
        draw_set_transform((from_pos + to_pos) * 0.5f, angle,
                           Vector2(1, 1) * clamped_zoom);
        draw_colored_polygon(TRIANGLE_POINTS, triangle_color);
        set_connection_activity(conn["from"], conn["from_port"], conn["to"],
                                conn["to_port"],
                                selected ? activity_amount : 0.0);
        bool valid = false;
        ...
        if (angle <= Math_PI / 2.0 && angle > -Math_PI / 2.0) {
            ...
            draw_set_transform((from_pos + to_pos) / 2.0f, angle,
                               Vector2(1, 1) * clamped_zoom);
        } else {
            // 上方反向显示
            top = (CLAMP(line_count - 1, 1.2, line_count) * char_high) *
                  Vector2(0, 1);
            draw_set_transform((from_pos + to_pos) / 2.0f, angle + Math_PI,
                               Vector2(1, 1) * clamped_zoom);
        }
        for (size_t i = 0; i < line_count; i++) {
            ...
            draw_string(font,
                        top + Vector2(-string_size.x / 2.0, i * string_size.y),
                        text, HORIZONTAL_ALIGNMENT_LEFT, -1, 16, text_color);
        }
    }

    if (_disconnect_line.size() == 2) {
        draw_set_transform(Vector2(0, 0), 0.0, Vector2(1, 1));
        draw_line(_disconnect_line[0], _disconnect_line[1],
                  Color::named("royal_blue"), 5, true);
    }
    if (!deferring) {
        deferring = true;
...
String StateNodesEditor::__get_variable_expression_res_valid_and_text(
    ...
    if (vr.is_valid()) {
        if (vr->get_type() != Variant::NIL) {
            ...
            if (ver->is_variable_as_value()) {
                if (auto vr =
                        Object::cast_to<HFSMVariableRes>(ver->get_value())) {
                    r_valid =
                        Variant::can_convert(Variant::Type(vr->get_type()),
                                             Variant::Type(vr->get_type()));
                    if (r_valid) {
                        return String(vr->get_name()) + get_op_text() +
                               String(vr->get_name());
                    } else {
                    ...
                    return str_localize(
                        "\"value\" is not a valid \"HFSMVariableRes\".");
                }
            } else {
                r_valid = Variant::can_convert(ver->get_value().get_type(),
                                               Variant::Type(vr->get_type()));
                if (r_valid) {
                    String value_text = "";
                    switch (vr->get_type()) {
                    case Variant::BOOL:
                        value_text =
                            ver->get_value().operator bool() ? "true" : "false";
                        break;
                    case Variant::INT:
                    case Variant::FLOAT:
...
List<String> StateNodesEditor::__get_transition_res_valid_and_texts(
    ...
    case TransitionRes::TRANSITION_TYPE_SCRIPT: {
        ...
        if (tr_script.is_valid()) {
            if (tr_script->is_class(String{"GDScript"}) &&
                (tr_script->call("get_instance_base_type")) ==
            ...
            if (r_valid) {
                ret.push_back(
                    // 第一行名称
                    str_localize("Script: ") +
                    (tr_script->get_name().is_empty()
                         ? (String("Build in ") + tr_script->get_class())
                         : tr_script->get_name()));
                ret.push_back(
                    // 第二行路径
                    tr_script->get_path());
                ...
                ret.push_back(
                    str_localize("Script isn't extends from \"Transition\"."));
                ret.push_back(str_localize(
                    "You can use other type of script if this is intended."));
            }
        } else {
    ...
    case TransitionRes::TRANSITION_TYPE_VARIABLE: {
        auto variable_expression_res_list =
            transition_res->get_variable_expression_res_list();
        if (variable_expression_res_list.size() > 0) {
            r_valid = true;
            ret.push_back(str_localize("HFSMVariable Expressions: ") +
                          String(transition_res->is_and_mode() ? "AND" : "OR"));
            for (size_t i = 0; i < variable_expression_res_list.size(); i++) {
                Ref<VariableExpressionRes> ver =
                    variable_expression_res_list[i];
                if (ver.is_valid()) {
                    ret.push_back(__get_variable_expression_res_valid_and_text(
                        ver, r_valid));
                    if (!r_valid)
                        break;
                } else {
                    r_valid = false;
                    ret.push_back(
                        str_localize("Invalid \"VariableExpressionRes\"."));
            ...
            ret.push_back(
                str_localize("HFSMVariable Expressions: ") +
                str_localize("Have not valid HFSMVariable Expression."));
        }
    } break;
    case TransitionRes::TRANSITION_TYPE_EXPRESSION: {
        ...
        if (transition_res->get_expression_text().is_empty()) {
            ...
            r_valid = true;
            ret.push_back(String("Expression: ") +
                          transition_res->get_expression_text());
            ret.push_back(String("Comment: ") +
                          transition_res->get_expression_comment());
        }
    } break;
    case TransitionRes::TRANSITION_TYPE_AUTO: {
        ...
        case TransitionRes::AUTO_TRANSIT_MODE_DELAY_TIMER: {
            r_valid = true;
            ret.push_back(str_localize("Auto: ") + str_localize("Delay ") +
                          itos(transition_res->get_auto_delay_msec()) +
                          str_localize(" msec."));
        } break;
        case TransitionRes::AUTO_TRANSIT_MODE_FSM_EXIT: {
            r_valid = true;
            ret.push_back(str_localize("Auto: ") +
                          str_localize("When sub Fsm exit."));
        } break;
        case TransitionRes::AUTO_TRANSIT_MODE_MANUAL: {
            r_valid = true;
            ret.push_back(str_localize("Auto: ") +
                          str_localize("After calling \"manual_exit()\"."));
        } break;
        case TransitionRes::AUTO_TRANSIT_MODE_UPDATE_TIMES: {
            r_valid = true;
            ret.push_back(str_localize("Auto: ") +
                          str_localize("After \"_update()\" being called ") +
                          itos(transition_res->get_auto_times()) +
                          str_localize(" times."));
        ...
        case TransitionRes::AUTO_TRANSIT_MODE_PHYSICS_UPDATE_TIMES: {
            ...
            ret.push_back(
                str_localize("Auto: ") +
                str_localize("After \"_physics_update()\" being called ") +
                itos(transition_res->get_auto_times()) +
                str_localize(" times."));
        }
        default:
